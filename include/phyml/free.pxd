...
cdef extern from "free.h" nogil:
    ...
    void Free_Calign(t_calign *data)
    void Free_Seq(t_align** d, int n_otu)
    void Free_All(t_align **d,t_calign *cdata,t_tree *tree)
    ...
    void Free_Actual_CSeq(t_calign *data)
