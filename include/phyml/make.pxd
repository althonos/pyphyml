...
cdef extern from "make.h" nogil:
    ...
    # nexcom    **Make_Nexus_Com(void);
    # nexparm    *Make_Nexus_Parm(void);
    ...
    # calign     *Make_Calign(int n_otu, int crunch_len, int state_len, int init_len,
    #                         char **sp_names, int n_rm, char **sp_names_out);
    ...
    # t_mcmc     *MCMC_Make_MCMC_Struct(void);
    ...
    # t_ll         *Make_Linked_List(void);
    # t_node      **Make_Target_Tip(int n);
    # t_clad       *Make_Clade(void);
