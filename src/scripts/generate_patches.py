...
RX = re.compile(r"diff --git a/([0-9a-zA-Z_\./]+) b/([0-9a-zA-Z_\./]+)")


parser = argparse.ArgumentParser()
parser.add_argument("--input", default=pathlib.Path("vendor", "phyml"), type=pathlib.Path)
parser.add_argument("--base", default="v3.3.20250515")
